...
setwd(dir="C:\Users\Florian\Desktop\Scripts-Evolution-CF-proteome-allocation\Plot-function")
...
par(mfrow=c(1,1),mai=c(1,1,0.5,2.25))
...
points(Rep_opt_DA_Deg_S40_perm[[2]][1:6]~log10(P_p2_set)[1:6],col="lightsalmon",pch=19,cex=2.5)
points(Rep_opt_DA_Deg_S40_perm[[2]][1:6]~log10(P_p2_set)[1:6],col="brown",pch=16)
points(Rep_opt_DA_Deg_S40_perm[[2]][7]~log10(P_p2_set)[7],col="lightsalmon",pch=1,cex=2.5)
points(Rep_opt_DA_Deg_S40_perm[[2]][7]~log10(P_p2_set)[7],col="brown",pch=16,cex=1)
points(Rep_opt_DA_Deg_S40_perm[[2]][8:9]~log10(P_p2_set)[8:9],col="lightsalmon",pch=1,cex=2.5)
points(Rep_opt_DA_Deg_S40_perm[[2]][8:9]~log10(P_p2_set)[8:9],col="brown",pch=1,cex=1)
points(x=-4,y=1,col="lightsalmon",pch=19,cex=2.5)
points(x=-4,y=1,,col="brown",pch=16)
points(x=-4,y=0,col="lightsalmon",pch=19,cex=2.5)
points(x=-4,y=0,,col="brown",pch=16)
points(x=-5,y=1,col="lightsalmon",pch=19,cex=2.5)
points(x=-5,y=1,,col="brown",pch=16)
points(x=-5,y=0,col="lightsalmon",pch=19,cex=2.5)
points(x=-5,y=0,,col="brown",pch=16)
...
legend(x=-2.8,y=0.5,title="Degradation rate",legend=c(expression(paste("Low, ",eta,"=",10^-3,s^-1)),expression(paste("High, ",eta,"=",10^-1.5,s^-1))),bty="y",pch=c(15),col=c(1:2),ncol=1,cex=0.9)

setwd(dir="~")
setwd(dir="/Users/florianlabourel/Desktop/Ongoing-projects/cross-feeding/Proteome allocation/Draft/SM/Figures-February")
dev.print(device = jpeg, file = "Cross-feeding-main.jpeg", , width = 675*6,height=500*6,res=600,type="cairo")
dev.off()

##End of main plot

##First illustrative plot -- global instability

ncol=800
jet.colors <- colorRampPalette(c(rep("white",400),rep("grey20",400)))
addtxt<-list(l=0.05,h=0.95,txt=c("B","C","D","E","F","G","H","I"),srt = 0,font=2,col="black")
palet<-jet.colors(ncol)
pal<-list(palet)
multiplePlot("","","","",c(""),c("")
             ,ncol=ncol,f_var_print,f_var_print,list(list_fit_inv_S40ratvar_Y1_eta1[[2]][[7]]),
             abs=expression(paste(delta," resident (% invetsment in 1st pathway)")),ord=expression(paste(delta," mutant (% invetsment in 1st pathway)")),scale=c(-99,99),palette=pal,cextext=2,TEXT_to_Add=addtxt,
             image=TRUE,pcex=1,subcex=1,labcex=2,axcex=1,globcex=0.65,legcex=1,contourlab=TRUE,meth="edge",contcex=0.5,colorkey=FALSE)
par(xpd=FALSE)
abline(v=Rep_opt_DA_Deg_S40_perm[[2]][7]+0.0025,lty=4,col=2,lwd=2)
points(x=Rep_opt_DA_Deg_S40_perm[[2]][7]+0.0025,y=Rep_opt_DA_Deg_S40_perm[[2]][7]+0.0025,col="brown",pch=1,cex=5)
points(x=Rep_opt_DA_Deg_S40_perm[[2]][7]+0.0025,y=Rep_opt_DA_Deg_S40_perm[[2]][7]+0.0025,col="red",pch=16,cex=2.5)
dev.print(device = jpeg, file = "PIP-ex-globinsta.jpeg", , width = 550*6,height=500*6,res=600,type="cairo")
dev.off()

##Second illustrative plot --global and local instability
addtxt<-list(l=0.05,h=0.95,txt=c("C","D","E","F","G","H","I"),srt = 0,font=2,col="black")
multiplePlot("","","","",c(""),c("")
             ,ncol=ncol,f_var_print,f_var_print,list(list_fit_inv_S40ratvar_Y1_eta1[[2]][[9]]),
             abs=expression(paste(delta," resident (% invetsment in 1st pathway)")),ord=expression(paste(delta," mutant (% invetsment in 1st pathway)")),scale=c(-99,99),palette=pal,cextext=2,TEXT_to_Add=addtxt,
             image=TRUE,pcex=1,subcex=1,labcex=2,axcex=1,globcex=0.65,legcex=1,contourlab=TRUE,meth="edge",contcex=0.5,colorkey=FALSE)
abline(v=Rep_opt_DA_Deg_S40_perm[[2]][9]+0.0025,lty=4,col=2,lwd=2)
points(x=Rep_opt_DA_Deg_S40_perm[[2]][9]+0.0025,y=Rep_opt_DA_Deg_S40_perm[[2]][9]+0.0025,col="brown",pch=1,cex=5)
points(x=Rep_opt_DA_Deg_S40_perm[[2]][9]+0.0025,y=Rep_opt_DA_Deg_S40_perm[[2]][9]+0.0025,col="red",pch=1,cex=2.5)
par(xpd=TRUE)
points(x=Rep_opt_DA_Deg_S40_perm[[2]][9]+0.0025,y=1,col="lightsalmon",pch=16,cex=5)
points(x=Rep_opt_DA_Deg_S40_perm[[2]][9]+0.0025,y=1,col="red",pch=16,cex=2.5)
points(x=Rep_opt_DA_Deg_S40_perm[[2]][9]+0.0025,y=0,col="lightsalmon",pch=16,cex=5)
points(x=Rep_opt_DA_Deg_S40_perm[[2]][9]+0.0025,y=0,col="red",pch=16,cex=2.5)
dev.print(device = jpeg, file = "PIP-ex-globlocinsta.jpeg", , width = 550*6,height=500*6,res=600,type="cairo")
dev.off()
