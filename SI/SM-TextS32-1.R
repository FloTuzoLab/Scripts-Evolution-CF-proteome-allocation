...
###1.Influence of degradation rate and fitness contributions on the allocation between subpathways (influence of transporters)
...
text(-5.75,0.81,"*",srt=addtxt$srt,font=2,col="black",cex=1)
text(-4.75,0.75,"*",srt=addtxt$srt,font=2,col="black",cex=1)
text(-3.75,0.74,"*",srt=addtxt$srt,font=2,col="black",cex=1)
...
dev.print(device = jpeg, file = "Cross-feeding-deg-comp-P01-costrans.jpeg", , width = 575*6,height=500*6,res=600,type="cairo")
dev.off()
...
Pop_DA1<-Pop_DA
multiplePlot("","","","",c("","",""),c("","","")
             ,ncol=800,f_var_print,f_var_print,list_fit_inv_S40ratvar_Y1_eta1[[3]],
             abs="res. (% 1st pathway)",ord="mut. (% 1st pathway)",scale=c(-999,999),lev=c(0),palette=pal,cextext=1.5,TEXT_to_Add=addtxt,
             image=TRUE,pcex=1,subcex=1,labcex=1.5,axcex=0.75,globcex=0.5,legcex=1,contourlab=TRUE,meth="edge",contcex=0.5,colorkey="COMMON")
...
text(-4.75,0.74,"*",srt=addtxt$srt,font=2,col="black",cex=1)
text(-3.75,0.73,"*",srt=addtxt$srt,font=2,col="black",cex=1)
...
setwd(dir="~")
setwd(dir="/Users/florianlabourel/Desktop/Ongoing-projects/cross-feeding/Proteome allocation/Draft/SM/Figures-February")
dev.print(device = jpeg, file = "Cross-feeding-deg-comp-P1-costrans.jpeg", , width = 575*6,height=500*6,res=600,type="cairo")
dev.off()
