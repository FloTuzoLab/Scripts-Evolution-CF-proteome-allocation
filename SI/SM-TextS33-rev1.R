...
Conc_opt_DA_Degperm_S40_rev_noperm

#2a.Adaptive dynamics with 2 sub-pathways, first pay-off value, low toxicity
...
points(Rep_opt_DA_RevTox_S40_perm[[1]]~log10(P_p2_set),col="light green",pch=19,cex=2.5)
points(Rep_opt_DA_RevTox_S40_perm[[1]]~log10(P_p2_set),col="dark green",pch=16,cex=1)
...
text(-9,1,"A",srt=addtxt$srt,font=2,col="black",cex=1)
...
dev.print(device = jpeg, file = "Cross-feeding-PO1-toxlowrev.jpeg", width = 575*3,height=500*3,res=300,type="cairo")
dev.off()
...
points(Rep_opt_DA_RevTox_S40_perm[[3]]~log10(P_p2_set),col="lightsalmon",pch=19,cex=2.5)
points(Rep_opt_DA_RevTox_S40_perm[[3]]~log10(P_p2_set),col="brown",pch=16)
text(-9,1,"B",srt=addtxt$srt,font=2,col="black",cex=1)
#text(-3.8,0.18,"*",srt=addtxt$srt,font=2,col="black",cex=1)
#text(-3.8,0.1,"o",srt=addtxt$srt,font=2,col=" light blue",cex=1)
par(xpd=TRUE)
legend("bottomleft",title="Singular strat.",legend=c("Loc. stable","Loc. instable","Glob. stable","Glob. instable"),bty="y",pch=c(20,1,19,1),col=c(1,"dark grey",1,1),pt.cex=c(1,1,1.75,1.75),ncol=1,cex=0.9)
...
setwd(dir="~")
setwd(dir="/Users/florianlabourel/Desktop/Ongoing-projects/cross-feeding/Proteome allocation/Draft/SM/Figures-February")
dev.print(device = jpeg, file = "Cross-feeding-PO1_10-toxlowrev.jpeg", width = 575*6,height=500*6,res=600,type="cairo")
dev.off()
