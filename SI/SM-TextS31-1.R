...
par(mfrow=c(1,1),mai=c(1,1,0.5,1),bg="white")
...
points(Rep_opt_DA_Deg_S40_perm[[2]][1:7]~log10(P_p2_set)[1:7],col="lightsalmon",pch=19,cex=2.5)
points(Rep_opt_DA_Deg_S40_perm[[2]][1:7]~log10(P_p2_set)[1:7],col="brown",pch=16)
points(Rep_opt_DA_Deg_S40_perm[[2]][8:9]~log10(P_p2_set)[8:9],col="lightsalmon",pch=1,cex=2.5)
points(Rep_opt_DA_Deg_S40_perm[[2]][8:9]~log10(P_p2_set)[8:9],col="brown",pch=16,cex=1)
text(-3.75,0.32,"*",srt=addtxt$srt,font=2,col="black",cex=1)
...
legend("topright",title="Degradation rate",legend=c(expression(paste(eta,"=",10^-2.5,s^-1)),expression(paste(eta,"=",10^-2,s^-1))),bty="y",pch=c(15),col=c(1:2),ncol=1,cex=0.9)
legend(x=-5.9,y=0.6,legend=c("Stable CF
...
dev.print(device = jpeg, file = "Cross-feeding-deg-comp.jpeg",bg="white", width = 575*3,height=500*3,res=300,type="cairo")
dev.off()
...
setwd(dir="~")
setwd(dir="/Users/florianlabourel/Desktop/Ongoing-projects/cross-feeding/Proteome allocation/Draft/SM/Figures-February")
dev.print(device = jpeg, file = "Cross-feeding-deg-comp-P1.jpeg", width = 575*3,height=500*3,res=300,type="cairo")
dev.off()
